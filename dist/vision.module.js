...
class BezierCurve {
     ...
     */
    B(t) {
        if(t < 0) { t = 0;}        if(t > 1) { t = 1;}        return this._BezierCurve.B(t);
    }
}
...
class _BezierCurve_Vector {
    ...
    _bc_node_generator(nodes, t) {
        ...
        for(let i=0, n=nodes.length-1; i<n; i++) {
            _nodes.push(Vector$1.lerp(nodes[i], nodes[i+1], t));
        }
        return _nodes;
    }
}
...
export { CanvasContext, Capturer, Particle, ParticleSystem, Tools, Vector$1 as Vector, Views, __index__$4 as algo, color, __index__$3 as math, __index__$2 as particle, renderer, __index__$1 as utils, vector, __index__ as views };
